-- CreateEnum
CREATE TYPE "Role" AS ENUM ('SUPER_ADMIN', 'ADMIN', 'MANAGER', 'MEMBER', 'GUEST');
...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('TASK_ASSIGNED', 'TASK_UPDATED', 'TASK_COMPLETED', 'TASK_COMMENTED', 'PROJECT_INVITATION', 'MENTION', 'DEADLINE_REMINDER', 'CHAT_MESSAGE');

-- CreateEnum
CREATE TYPE "ActivityType" AS ENUM ('CREATED', 'UPDATED', 'DELETED', 'ASSIGNED', 'UNASSIGNED', 'STATUS_CHANGED', 'PRIORITY_CHANGED', 'COMMENTED', 'ATTACHED_FILE', 'MOVED');
...
-- CreateIndex
CREATE INDEX "task_schedules_isActive_idx" ON "task_schedules"("isActive");

-- CreateIndex
CREATE INDEX "task_schedules_nextRunAt_idx" ON "task_schedules"("nextRunAt");
...
-- AddForeignKey
ALTER TABLE "task_schedules" ADD CONSTRAINT "task_schedules_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
