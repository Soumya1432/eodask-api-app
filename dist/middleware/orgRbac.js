...
export const requireMinOrgRole = (minRole) => {
    return async (req, _res, next) => {
        try {
            if (!req.user) {
                throw ApiError.unauthorized('Authentication required');
...
export const requireOrgAccess = async (req, _res, next) => {
    try {
        if (!req.user) {
            throw ApiError.unauthorized('Authentication required');
        }
...
export const requireOrgOwner = async (req, _res, next) => {
    try {
        if (!req.user) {
            throw ApiError.unauthorized('Authentication required');
        }
...
export const hasMinOrgRoleLevel = (userRole, minRole) => {
    return getOrgRoleLevel(userRole) >= getOrgRoleLevel(minRole);
};
//# sourceMappingURL=orgRbac.js.map