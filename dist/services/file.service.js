...
class FileService {
    ...
    async uploadTaskAttachment(file, taskId, uploaderId) {
        ...
        const uploadResult = await cloudinaryService.uploadBuffer(file.buffer, file.originalname, {
    ...
    async getDownloadUrl(attachmentId) {
        ...
        if (attachment.url.includes('cloudinary.com')) {
            return cloudinaryService.getDownloadUrl(attachment.fileName, attachment.originalName);
        }
